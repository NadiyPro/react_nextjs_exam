...
const VideosPage = async ({ params }: { params: { movie_id: string }}) => {
    ...
    return (
        <div className='div_VideosPage'>
            <FormComponent/>
            <div className='div_inner_VideosPage'>
                {video ? (
                    <div>
                        <h2>{video.name}</h2>
                        <iframe
                    ...
                    <div className='div_error_MovieSearchPage'>
                        ...
                        <div>
                            <h3 className='h3_error_div_error_MovieSearchPage'>No videos available</h3>
                ...
                <div className='div_button_VideosPage'>
                    <button className='button_pagination'>
                        <Link className='Link_VideosPage' href={`/movie/${movie_id}` }>Back</Link>
                    </button>
                    <button className='button_pagination'>
                        <Link className='Link_VideosPage' href={'/discover/movie?page=1'}>Home</Link>
                    </button>
                </div>
            </div>
        </div>
